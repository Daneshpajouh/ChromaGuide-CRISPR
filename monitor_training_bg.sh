...
# 
# Start:  bash monitor_training_bg.sh start
# Stop:   bash monitor_training_bg.sh stop
# Status: bash monitor_training_bg.sh status
# View:   tail -f training_monitor_56715343.log
################################################################################
