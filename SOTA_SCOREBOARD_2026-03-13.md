# SOTA Scoreboard (2026-03-13)

- Generated at: `2026-03-13T08:48:49.480051+00:00`
...
|---|---:|---:|---:|---|---|---|
| on_target.mean9_scc | 0.6743715317 | 0.716 | -0.0416284683 | No | Yes | scored |
| on_target.WT_scc | 0.8472109768 | 0.861 | -0.0137890232 | No | Yes | scored |
| on_target.ESP_scc | 0.836197832 | 0.851 | -0.014802168 | No | Yes | scored |
| on_target.HF_scc | 0.8398865386 | 0.865 | -0.0251134614 | No | Yes | scored |
| on_target.Sniper_Cas9_scc | 0.9298523422 | 0.935 | -0.0051476578 | No | Yes | scored |
| on_target.HL60_scc | 0.3130585941 | 0.402 | -0.0889414059 | No | Yes | scored |
...
| Metric | Best | Target | Gap (best-target) | Pass | Claim-valid | Status |
|---|---:|---:|---:|---|---|---|
| uncertainty.CHANGE_seq_test_spearman | 0.5119756727 | 0.5114 | 0.0005756727 | Yes | No | scored |

Notes:
- `uncertainty.CHANGE_seq_test_spearman`: Exact-bundle topology diagnosis: raw-mean Spearman on CHANGEseq_reads_adjusted = 0.5119756727; this clears the frozen 0.5114 threshold numerically. Prior 0.453984 path came from a stale Box-Cox+jitter evaluator. Claim-validity is still pending exact paper metric attribution.
