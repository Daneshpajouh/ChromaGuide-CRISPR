...
#SBATCH --output=~/scratch/chromaguide_v4/logs/cg4_evo_sA_f0_r42_%j.out
#SBATCH --error=~/scratch/chromaguide_v4/logs/cg4_evo_sA_f0_r42_%j.err

echo "============================================"
echo "ChromaGuide v4 Experiment"
echo "Job: cg4_evo_sA_f0_r42"
echo "Cluster: nibi"
echo "Backbone: evo"
echo "Split: A (fold 0)"
echo "Seed: 42"
...
echo "============================================"
echo "Experiment complete: cg4_evo_sA_f0_r42"
echo "Date: $(date)"
echo "============================================"
