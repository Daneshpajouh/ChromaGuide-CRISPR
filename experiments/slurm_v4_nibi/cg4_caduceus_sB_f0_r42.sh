#!/bin/bash
#SBATCH --job-name=cg4_cadu_B_s42
...
#SBATCH --output=~/scratch/chromaguide_v4/logs/cg4_caduceus_sB_f0_r42_%j.out
#SBATCH --error=~/scratch/chromaguide_v4/logs/cg4_caduceus_sB_f0_r42_%j.err

echo "============================================"
echo "ChromaGuide v4 Experiment"
echo "Job: cg4_caduceus_sB_f0_r42"
echo "Cluster: nibi"
...
echo "============================================"
echo "Experiment complete: cg4_caduceus_sB_f0_r42"
echo "Date: $(date)"
echo "============================================"
