#!/bin/bash
#SBATCH --job-name=cg4_cadu_B_s456
...
#SBATCH --output=~/scratch/chromaguide_v4/logs/cg4_caduceus_sB_f0_r456_%j.out
#SBATCH --error=~/scratch/chromaguide_v4/logs/cg4_caduceus_sB_f0_r456_%j.err

echo "============================================"
echo "ChromaGuide v4 Experiment"
echo "Job: cg4_caduceus_sB_f0_r456"
...
echo "============================================"
echo "Experiment complete: cg4_caduceus_sB_f0_r456"
echo "Date: $(date)"
echo "============================================"
