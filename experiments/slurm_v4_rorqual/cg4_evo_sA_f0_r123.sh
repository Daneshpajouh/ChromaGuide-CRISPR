#!/bin/bash
#SBATCH --job-name=cg4_evo_A_s123
...
#SBATCH --output=~/scratch/chromaguide_v4/logs/cg4_evo_sA_f0_r123_%j.out
#SBATCH --error=~/scratch/chromaguide_v4/logs/cg4_evo_sA_f0_r123_%j.err

echo "============================================"
echo "ChromaGuide v4 Experiment"
echo "Job: cg4_evo_sA_f0_r123"
...
echo "============================================"
echo "Experiment complete: cg4_evo_sA_f0_r123"
echo "Date: $(date)"
echo "============================================"
