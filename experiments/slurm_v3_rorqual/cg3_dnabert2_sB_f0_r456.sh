#!/bin/bash
#SBATCH --job-name=cg3_dnab_sB_f0_r456
...
#SBATCH --output=~/scratch/chromaguide_v3/logs/cg3_dnab_sB_f0_r456_%j.out
#SBATCH --error=~/scratch/chromaguide_v3/logs/cg3_dnab_sB_f0_r456_%j.err

echo "============================================"
echo "ChromaGuide v3 Experiment"
echo "Job: cg3_dnab_sB_f0_r456"
...
echo "============================================"
echo "Experiment complete: cg3_dnab_sB_f0_r456"
echo "Date: $(date)"
echo "============================================"
