#!/bin/bash
#SBATCH --job-name=cg-nucleo-C-s42
...
#SBATCH --output=results/nucleotide_transformer_splitC_seed42/slurm-%j.out
#SBATCH --error=results/nucleotide_transformer_splitC_seed42/slurm-%j.err

# ============================================================
# ChromaGuide: nucleotide_transformer | Split C | Seed 42
# Cluster: fir (A100)
# ============================================================
...
mkdir -p results/nucleotide_transformer_splitC_seed42
...
if [ -f results/nucleotide_transformer_splitC_seed42/results.json ]; then
    echo ""
    echo "=== RESULTS ==="
    python -c "
import json
with open('results/nucleotide_transformer_splitC_seed42/results.json') as f:
    r = json.load(f)
