...
if [ -f ~/scratch/chromaguide_v2/results/dnabert2_splitB_seed123/metrics.json ]; then
    python -c "
import json
with open('~/scratch/chromaguide_v2/results/dnabert2_splitB_seed123/metrics.json') as f:
    r = json.load(f)
