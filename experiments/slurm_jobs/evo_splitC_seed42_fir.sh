...
#SBATCH --output=results/evo_splitC_seed42/slurm-%j.out
#SBATCH --error=results/evo_splitC_seed42/slurm-%j.err

# ============================================================
# ChromaGuide: evo | Split C | Seed 42
# Cluster: fir (A100)
# ============================================================
...
mkdir -p results/evo_splitC_seed42
...
if [ -f results/evo_splitC_seed42/results.json ]; then
    echo ""
    echo "=== RESULTS ==="
    python -c "
import json
with open('results/evo_splitC_seed42/results.json') as f:
    r = json.load(f)
