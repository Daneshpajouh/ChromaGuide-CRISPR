#!/bin/bash
#SBATCH --job-name=cg3_evo_sA_f0_r42
...
#SBATCH --output=~/scratch/chromaguide_v3/logs/cg3_evo_sA_f0_r42_%j.out
#SBATCH --error=~/scratch/chromaguide_v3/logs/cg3_evo_sA_f0_r42_%j.err

echo "============================================"
echo "ChromaGuide v3 Experiment"
echo "Job: cg3_evo_sA_f0_r42"
echo "Cluster: narval"
echo "Backbone: evo"
echo "Split: A (fold 0)"
echo "Seed: 42"
...
echo "============================================"
echo "Experiment complete: cg3_evo_sA_f0_r42"
echo "Date: $(date)"
echo "============================================"
