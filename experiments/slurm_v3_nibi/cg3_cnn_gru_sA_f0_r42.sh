#!/bin/bash
#SBATCH --job-name=cg3_cnn__sA_f0_r42
...
#SBATCH --output=~/scratch/chromaguide_v3/logs/cg3_cnn__sA_f0_r42_%j.out
#SBATCH --error=~/scratch/chromaguide_v3/logs/cg3_cnn__sA_f0_r42_%j.err

echo "============================================"
echo "ChromaGuide v3 Experiment"
echo "Job: cg3_cnn__sA_f0_r42"
echo "Cluster: nibi"
...
echo "============================================"
echo "Experiment complete: cg3_cnn__sA_f0_r42"
echo "Date: $(date)"
echo "============================================"
