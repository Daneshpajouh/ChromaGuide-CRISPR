#!/bin/bash
#SBATCH --job-name=cg3_evo_sC_f0_r456
...
#SBATCH --output=~/scratch/chromaguide_v3/logs/cg3_evo_sC_f0_r456_%j.out
#SBATCH --error=~/scratch/chromaguide_v3/logs/cg3_evo_sC_f0_r456_%j.err

echo "============================================"
echo "ChromaGuide v3 Experiment"
echo "Job: cg3_evo_sC_f0_r456"
echo "Cluster: nibi"
echo "Backbone: evo"
echo "Split: C (fold 0)"
echo "Seed: 456"
...
echo "============================================"
echo "Experiment complete: cg3_evo_sC_f0_r456"
echo "Date: $(date)"
echo "============================================"
