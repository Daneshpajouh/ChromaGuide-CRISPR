#!/bin/bash
#SBATCH --job-name=cg4_cadu_A_s123
...
#SBATCH --output=~/scratch/chromaguide_v4/logs/cg4_caduceus_sA_f0_r123_%j.out
#SBATCH --error=~/scratch/chromaguide_v4/logs/cg4_caduceus_sA_f0_r123_%j.err

echo "============================================"
echo "ChromaGuide v4 Experiment"
echo "Job: cg4_caduceus_sA_f0_r123"
echo "Cluster: narval"
...
echo "============================================"
echo "Experiment complete: cg4_caduceus_sA_f0_r123"
echo "Date: $(date)"
echo "============================================"
