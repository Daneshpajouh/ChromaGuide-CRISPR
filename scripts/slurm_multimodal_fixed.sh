#!/bin/bash
#SBATCH --job-name=chromaguide-multimodal-fixed
#SBATCH --account=def-kwiese_gpu
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
#SBATCH --time=12:00:00
#SBATCH --cpus-per-task=8
#SBATCH --output=slurm_logs/multimodal_fixed_%j.out
#SBATCH --error=slurm_logs/multimodal_fixed_%j.err
...
# Run with unbuffered output and DNABERT-2 loaded from cache
