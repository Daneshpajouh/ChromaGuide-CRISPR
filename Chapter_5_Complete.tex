...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/fig_5_1.png}
    \caption[DNA Mismatch "Bubble" Instability]{Structural instability caused by DNA-DNA mismatches: The non-complementary bases (e.g., A-G) create a "bubble" in the helix, localized thermodynamic instability that Cas9 ignores if PAM-distal but rejects if PAM-proximal.}
    \label{fig:mismatch_bubble}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/fig_5_2.png}
    \caption[RNA vs DNA Bulges]{Structural comparison of mismatch bulges: (A) DNA-DNA mismatch causes symmetric helical distortion. (B) sgRNA-DNA hybrid mismatch causes asymmetric RNA bulging, affecting Cas9 R-loop formation kinetics.}
    \label{fig:rna_dna_bulge}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/fig_5_3.png}
    \caption[Kinetic Proofreading Model]{Steps of Cas9 binding and cleavage as a kinetic proofreading process. Mismatches increase the unbinding rate ($k_{off}$), preventing the transition to the cleavage-competent state.}
    \label{fig:kinetic_proofreading}
\end{figure}
...
\begin{figure}[h!]
    ...
    \caption[Genome-Wide Off-Target Risk Map]{Visualizing cumulative off-target risk across the genome. Red bands indicate chromosomal regions with high density of predicted off-target cuts for a given guide, highlighting "risk hotspots".}
    \label{fig:risk_map}
\end{figure}
