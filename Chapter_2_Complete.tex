...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/fig_2_1.png}
    \caption[The Manifold Hypothesis]{Visualization of the Manifold Hypothesis: High-dimensional data (like genomic sequences) lie on a low-dimensional manifold embedded in the ambient space.}
    \label{fig:manifold}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/fig_2_2.png}
    \caption[KL-Divergence Visualization]{Geometric interpretation of Kullback-Leibler Divergence as the asymmetric distance between two probability distributions $P$ and $Q$.}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/fig_2_3.png}
    \caption[Convolutional Operations]{Structure of Convolutional Neural Networks (CNNs) used for motif detection in genomic sequences.}
    \label{fig:cnn_ops}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/fig_2_4.png}
    \caption[Recurrent Neural Network Loop]{Unrolled representation of a Recurrent Neural Network (RNN) processing sequential data.}
    \label{fig:rnn_loop}
\end{figure}
